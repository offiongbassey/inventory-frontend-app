        ...
        <Card cardClass="card">
            ...
            {product && (
                <div className="detail">
                    ...
                    <p>
                        <b>&rarr; SKU: </b> {product.sku} <br/>
                    </p>
                     <p>
                        <b>&rarr; Category: </b> {product.category} <br/>
                    </p>
                     <p>
                        <b>&rarr; Price: </b> {`${product.price}`} <br/>
                    </p>
                     <p>
                        <b>&rarr; Quantity in stock: </b> {product.quantity} <br/>
                    </p>
                     <p>
                        <b>&rarr; Total value in stock: </b>{`$${product.quantity * product.price}`} <br/>
                    </p>
                        <hr/>
